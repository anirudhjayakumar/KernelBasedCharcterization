...
'div':['idiv'],
'divss':['divsd'],
'ja':['ja','jae','jb','jbe','jc','jcxz','je','jecxz','jg','jge','jl','jle','jna','jnae','jnb','jnbe','jnc','jne','jng','jnge','jnl','jnle','jno','jnp','jns','jnz','jo','jp','jpe','jpo','js','jz'],
'mul':['imul'],
'mulsd':['mulss'],
'mov':['movb','movl','movq'],# 'movapd' , 'movaps', 'movsd'],
'movapd':['movaps'],
'movsd':['movss']
}
