...
public:
    ...
    set<SgNode*>	     GetLoopNodes()
    {
        return m_loopNodes;
    }
    VecSFunctionCallDef	 GetFunctionCallDefs()
    {
        return m_funcCalls;
    }
    set<SgFunctionCallExp*> GetMPICalls()
    {
        return m_MPICalls;
    }
    void     		 SetNestDepth(NestingDepth depth)
    {
        m_depth = depth;
    }
    ...
    void             SetFunctionCallDef(SFunctionCallDefPtr def)
    {
        m_funcCalls.push_back(def);
    }
    ...
    void             SetMPICallDef(SgFunctionCallExp* def)
    {
        m_MPICalls.insert(def);
    }
...
public:
    ...
    {
        m_pProject = NULL;
        m_mapFunDeftoLoops.clear();
        m_mapLoopNodetoAnnotation.clear();
    }
